...
public class TwoTextListViewAdapter extends ArrayAdapter<String> {

    private Context context;
    private ArrayList<String> texts1;
    private ArrayList<String> texts2;

    public TwoTextListViewAdapter(Context context, int resource, ArrayList<String> texts1, ArrayList<String> texts2) {
